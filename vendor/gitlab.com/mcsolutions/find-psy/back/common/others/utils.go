...
// PFloat32 returns an float32 value from a pointer
...
// PFloat64 returns an float64 value from a pointer
...
func PStringSplitSlice(value *string) []string {
	if value == nil {
		return []string{}
	}
...
func CommasAround(slice []string) string {
	if len(slice) == 0 {
		return ""
	}
...
func PStringSplitSliceTrimCommas(value *string) []string {
	if value == nil {
		return []string{}
	}
...
func StringSlice2PString(value []string) *string {
	if len(value) == 0 {
		return nil
	}
...
func PTimestamp(value *time.Time) *timestamppb.Timestamp {
	if value == nil {
		return nil
	}
...
func Timestamp2Time(value *timestamppb.Timestamp) *time.Time {
	if value == nil {
		return nil
	}
	result := value.AsTime()
...
func StringValue(value *string) *common.String {
	if value == nil {
		return nil
	}
	return &common.String{Value: *value}
}

func PStringValue(value *common.String) *string {
	if value == nil {
		return nil
	}
	return &value.Value
...
func GetPrice(cur *string, price *uint32) *common.Price {
	if cur != nil && price != nil {
		return &common.Price{
			Currency: *cur,
			Value:    *price,
		}
